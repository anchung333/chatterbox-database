...
describe('Persistent Node Chat Server', function () {
  ...
  beforeEach(function (done) {
    dbConnection = mysql.createConnection({
      user: 'student',
      password: 'student',
      database: 'chatterbox' // 'chat'
    });
    dbConnection.connect();

    var tablenames = ['messages']; // TODO: fill this out
  ...
  it('Should output all messages from the DB', function (done) {
    ...
    var queryString = 'INSERT INTO messages (contents, user_id, room_id) VALUES (\'Men like you can never change!\', 1, 1)';
    var queryArgs = [];
    ...
    dbConnection.query(queryString, queryArgs, function (err) {
      ...
      request('http://127.0.0.1:3000/classes/messages', function (error, response, body) {
        ...
        expect(messageLog[0].roomname).to.equal('room 1');
        done();
      });
    });
  });
