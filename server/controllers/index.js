...
module.exports = {
  messages: {
    get: function (req, res) {
      console.log('successfully hit the message/GET handler');
      console.log('req body:', req.body);

      models.messages.get(req.body, data => {
        console.log('database response: ', data);
        res.end(JSON.stringify(data));
      });
    }, // a function which handles a get request for all messages Invoke a model method with data, receive it back, send all data to client to render/display
